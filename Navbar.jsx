...
import "./Navbar.css";
import {FaTwitter, FaSkype, FaVimeoV, FaInstagram, FaFacebook} from "react-icons/fa";
        ...
        <div className='container w-100'>
            <div className='navbar-content flex fw-7'>
                <div className='brand-and-toggler flex flex-between w-100'>
                    <Link to = "/" className='navbar-brand fs-26'>StudentInfo.</Link>
                ...
                <div className={`navbar-collapse ${navToggle ? 'show-navbar-collapse' : ""}`}>
                    <div className='navbar-collapse-content'>
                        ...
                        <div className='navbar-btns'>
                            <button type = "button" className='btn'><IoMdRocket /> <span>load Info!</span></button>
                        </div>
                    </div>
                </div>
            </div>
